...
/**
 * Class for creating connection to BLE device and sending data to the appropriate service so they can be read in Arduino.
 * Created by Matej Danicek on 19.7.18.
 */
class BLEConnection {

    //USAGE:
//    final BLEConnection connection = new BLEConnection();
//
//        boolean connectingStarted = connection.connect(this /*if calling from activity*/, "20:91:48:BC:CA:BA", new BLEConnection.ConnectionChangedListener() {
//            @Override
//            public void onConnectionChanged(boolean connected) {
//                if (connected) {
//                    //we are connected and can send data using the connection object
//                    connection.sendData("Hello there"); //send data
//                } else {
//                    //connection was broken or could not be established = we cant send data anymore
//                }
//            }
//        });
//
//        if (connectingStarted) {
//            //connecting started and we are now waiting for connection established and BLE service discovered (when done the onConnectionChanged method will be called)
//        } else {
//            //connecting could not be started (maybe disabled BT?)
//        }
